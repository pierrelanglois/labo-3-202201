# -------------------------------------------------------------------------------
# labo_3_synth_impl.tcl
#
# Il faut d'abord ouvrir une fenêtre d'invite de commande (dans Windows : cmd).
# Ensuite naviguer dans le bon répertoire, par exemple user\docs\poly\inf3500\labo-3\synthese-implementation
#
...
#synth_design -top top_labo_3 -part xC7a50TCSG324 -assert
#synth_design -top top_labo_3 -part xC7a100TCSG324 -assert
...
#set_property PROGRAM.FILE {top_labo_3.bit} [get_hw_devices xc7a50t_0]
#program_hw_devices [get_hw_devices xc7a50t_0]

#current_hw_device [get_hw_devices xc7a100t_0]
#set_property PROGRAM.FILE {top_labo_3.bit} [get_hw_devices xc7a100t_0]
